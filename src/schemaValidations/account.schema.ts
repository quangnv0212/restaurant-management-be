...
export const AccountListWithPaginationQuery = z.object({
...
export type AccountListWithPaginationQueryType = z.TypeOf<typeof AccountListWithPaginationQuery>

export const AccountListWithPaginationRes = z.object({
  data: z.object({
    totalItem: z.number(),
    totalPage: z.number(),
    page: z.number(),
...
export type AccountListWithPaginationResType = z.TypeOf<typeof AccountListWithPaginationRes>
